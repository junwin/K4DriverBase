...
namespace DriverBase
{
    ...
    /// an external API
    /// </summary>
    public class OrderContext :IMessageHeader
    {
        ...
        private decimal m_FilledVolume = 0;
        private decimal m_TotalFillXVol = 0;
        private decimal m_AveragePrice = 0;
        ...
        public OrderContext(string clientId, string clientSubId, string correlationId)
        {
        ...
        public decimal GetAverageFillPx()
        {
            try
            {
                if (m_FilledVolume > 0)
        ...
        public decimal LastAveragePrice
        {
            get { return m_AveragePrice; }
            set { m_AveragePrice = value; }
        }

        public void AddFillData(decimal myVolume, decimal myPx)
        {
            try
            {
